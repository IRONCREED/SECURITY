<?php
/** Production archive must contain only the complete WordPress.org runtime allowlist. */
...
$actual = explode( "\n", trim( $stdout ) );
$relative = array( 'ironcreed-request-log.php', 'uninstall.php', 'readme.txt', 'license.txt', 'changelog.txt', 'docs/HOSTING-UKRAINE-API-CONTRACT.md', 'assets/admin.css', 'assets/admin.js' );
